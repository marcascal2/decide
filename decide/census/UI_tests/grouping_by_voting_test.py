...
class TestGroupingbyvotingtest(StaticLiveServerTestCase):
  ...
  def grouping_by_voting_test(self):
    ...
    self.driver.find_element(By.ID, "agrupar_votacion").click()
    ...
    self.driver.find_element(By.LINK_TEXT, "voting_testing2").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".filas-tabla > td:nth-child(1)").text == "voting_testing2"
